...
import com.bezkoder.spring.security.mongodb.payload.request.GrantRoleRequest;
...
import com.bezkoder.spring.security.mongodb.repository.UserRoleRepository;
...
public class AuthController {
  ...
  public ResponseEntity<?> grantRole(@Valid @RequestBody GrantRoleRequest grantRoleRequest) {
	  System.out.println("grantRoleRequest::"+grantRoleRequest.getUsername()+"::"+grantRoleRequest.getRole());
   /* if (userRepository.existsByUsername(grantRoleRequest.getUsername())) {
      return ResponseEntity
          .badRequest()
          .body(new MessageResponse("Error: Username is already taken!"));
    }

    if (userRepository.existsByEmail(grantRoleRequest.getRole())) {
      return ResponseEntity
          .badRequest()
          .body(new MessageResponse("Error: Email is already in use!"));
    }*/
    ...
    // Create new user's account
    RoleUser userrole = new RoleUser(grantRoleRequest.getUsername(), grantRoleRequest.getRole());
